...
KEYWORDS = [
    ...
    # فلسطين
    "فلسطين", "فلسطيني", "غزة", "الضفة", "حماس", "القدس", "الأقصى", "خان يونس", "رفح", "جنين",
    # روسيا-أوكرانيا
    "روسيا", "روسي", "بوتين", "موسكو", "الكرملين",
    "أوكرانيا", "اوكرانيا", "أوكراني", "زيلينسكي", "كييف",
    # أمريكا
    "أمريكا", "امريكا", "أمريكي", "ترامب", "بايدن", "واشنطن", "البيت الأبيض", "البنتاغون",
    # الوطن العربي
    "السعودية", "الإمارات", "مصر", "الأردن", "سوريا", "العراق", "اليمن", "لبنان", "ليبيا", "السودان",
    "الحوثي", "الحوثيون", "صنعاء", "البحر الأحمر",
    # كلمات الحدث
    "حرب", "هجوم", "صاروخ", "قصف", "اشتباك", "غارة", "ضربة", "عملية عسكرية", "تصعيد", "اقتحام", "اغتيال",
]
